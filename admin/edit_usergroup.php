    ...
    if (!empty($query)) {
        ...
        if (isset($_POST['update'])) {
            try {
                ...
                $style = $_POST['g_style'];
                $bstyle_s = $_POST['b_style_s'];
                $bstyle_e = $_POST['b_style_e'];
                ...
                if (!$name or !$style) {
                    ...
                    $MYSQL->bindMore(array(
                        'group_name' => $name,
                        'group_style' => $style,
                        'banner_style_s' => $bstyle_s,
                        'banner_style_e' => $bstyle_e,
                        'group_permissions' => $permissions,
                        'id' => $id));
                    ...
                    try {
                        ...
                        $MYSQL->query('UPDATE {prefix}usergroups SET group_name = :group_name, group_style = :group_style, banner_style_s = :banner_style_s, banner_style_e = :banner_style_e, group_permissions = :group_permissions WHERE id = :id');
        ...
        echo $ADMIN->box(
            ...
            '<form action="" method="POST">
                 ...
                 <textarea name="b_style_s" id="b_style_s" class="form-control">' . $query['0']['banner_style_s'] . '</textarea>
                 <label for="b_style_e">Banner Style End</label>
                 <textarea name="b_style_e" id="b_style_e" class="form-control">' . $query['0']['banner_style_e'] . '</textarea>
