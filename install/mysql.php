...
if (isset($_POST['submit_mysql'])) {
    try {
        ...
        if (!$mysql_host or !$mysql_username or !$mysql_database or !$mysql_prefix) {//Check if all values are there.
            ...
            $config = str_replace('%site_path%', $site_path, $config);
            ...
            $MYSQL->query("DROP TABLE IF EXISTS `" . $mysql_prefix . "apps`;
                           ...
                           DROP TABLE IF EXISTS `" . $mysql_prefix . "user_followers`;
                           ...
                           DROP TABLE IF EXISTS `" . $mysql_prefix . "nav`;
                           DROP TABLE IF EXISTS `" . $mysql_prefix . "sidebar`;
                           DROP TABLE IF EXISTS `" . $mysql_prefix . "profile_fields`;
                           DROP TABLE IF EXISTS `" . $mysql_prefix . "profile_field_content`;
                           ");
            ...
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "generic` (`id` int(11) NOT NULL AUTO_INCREMENT, `site_rules` text NOT NULL, `site_name` varchar(255) NOT NULL, `site_theme` int(11) NOT NULL, `site_language` varchar(255) NOT NULL, `site_email` varchar(255) NOT NULL, `register_enable` int(11) NOT NULL DEFAULT '1', `register_email_activate` int(11) NOT NULL DEFAULT '0', `captcha_type` int(11) NOT NULL DEFAULT '1', `recaptcha_public_key` varchar(255) NOT NULL DEFAULT '0', `recaptcha_private_key` varchar(255) NOT NULL DEFAULT '0', `mail_type` int(11) NOT NULL DEFAULT '1', `post_merge` int(1) NOT NULL DEFAULT '1', `flat_ui_admin` INT NOT NULL DEFAULT '0', `number_subs` INT(3) DEFAULT 3  NOT NULL, `site_enable` INT(1) DEFAULT 1  NOT NULL, `offline_msg` LONGTEXT NULL, `whiteboard` LONGTEXT NULL, `logo` varchar(255), `board_signature` LONGTEXT NULL, `enable_rtl` INT(1) DEFAULT 0  NOT NULL, `enable_signatures` INT(1) DEFAULT 1  NOT NULL,`enable_pcomments` INT(1) DEFAULT 1  NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;");
            ...
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "usergroups` (`id` int(11) NOT NULL AUTO_INCREMENT, `group_name` varchar(255) NOT NULL, `group_style` varchar(255) NOT NULL DEFAULT '%username%', `banner_style_s` varchar(255) NOT NULL DEFAULT '<span class=\"label label -default\">', `banner_style_e` varchar(255) NOT NULL DEFAULT '</span>', `group_permissions` varchar(255) NOT NULL DEFAULT '0', `is_staff` int(11) NOT NULL DEFAULT '0', PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=0 ;");
           
            $MYSQL->query("INSERT INTO `" . $mysql_prefix . "usergroups` (`id`, `group_name`, `group_style`, `group_permissions`, `is_staff`) VALUES (0, 'Guest', NULL, '1', '0'),(1, 'User', '<span>%username%</span>', '1,2,3', '0'),(2, 'Banned', '<span>%username% (Banned)</span>', '0', '0'),(3, 'Moderator', '<span style=\"color:#3a5892;\"><strong>%username%</strong></span>', '1,2,3,4', '1'),(4, 'Administrator', '<span style=\"color:#762727;\"><strong>%username%</strong></span>', '*', '1');");

            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "users` (`id` int(11) NOT NULL AUTO_INCREMENT, `username` varchar(255) NULL, `user_password` varchar(255) NULL, `user_email` varchar(255) NULL,`user_message` varchar(255) NULL DEFAULT 'User', `user_avatar` varchar(255) NULL DEFAULT 'default.png', `avatar_type` int(11) NULL DEFAULT '0', `user_signature` LONGTEXT NULL,`about_user` LONGTEXT NULL, `location` varchar (2) NULL DEFAULT '--', `gender` int(1) DEFAULT '0', `date_joined` int(11) NULL,`user_birthday` date NULL, `additional_permissions` varchar(255) NULL DEFAULT '0',  `user_group` int(11) NULL DEFAULT '1', `display_group` INT NULL, `chosen_theme` int(11) NULL DEFAULT '0', `set_timezone` varchar(255) NULL DEFAULT 'US/Central', `user_disabled` int(11) NULL DEFAULT '0', `is_banned` int(11) NULL DEFAULT '0', `unban_time` int(11) NULL, `ban_reason` varchar(255) NULL DEFAULT 'None', PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;");
