...
if (isset($_POST['submit'])) {
    try {
        ...
        if (!$mysql_host or !$mysql_username or !$mysql_database or !$mysql_prefix) {//Check if all values are there.
            ...
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "generic` (`id` int(11) NOT NULL AUTO_INCREMENT, `site_rules` text NOT NULL, `site_name` varchar(255) NOT NULL, `site_theme` int(11) NOT NULL, `site_language` varchar(255) NOT NULL, `site_email` varchar(255) NOT NULL, `register_enable` int(11) NOT NULL DEFAULT '1', `register_email_activate` int(11) NOT NULL DEFAULT '0', `facebook_authenticate` int(11) NOT NULL DEFAULT '0', `facebook_app_id` varchar(255) NOT NULL DEFAULT '0', `facebook_app_secret` varchar(255) NOT NULL DEFAULT '0', `captcha_type` int(11) NOT NULL DEFAULT '1', `recaptcha_public_key` varchar(255) NOT NULL DEFAULT '0', `recaptcha_private_key` varchar(255) NOT NULL DEFAULT '0', `mail_type` int(11) NOT NULL DEFAULT '1', `smtp_address` varchar(255) NOT NULL DEFAULT '0', `smtp_port` int(11) NOT NULL DEFAULT '0', `smtp_username` varchar(255) NOT NULL DEFAULT '0', `smtp_password` varchar(255) NOT NULL DEFAULT '0', `post_merge` int(1) NOT NULL DEFAULT '1', `flat_ui_admin` INT NOT NULL DEFAULT '0', `number_subs` INT(3) DEFAULT 3  NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;");
            ...
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "users` (`id` int(11) NOT NULL AUTO_INCREMENT, `username` varchar(255) NOT NULL, `user_password` varchar(255) NOT NULL, `user_email` varchar(255) NOT NULL,`user_message` varchar(255) NOT NULL DEFAULT 'User', `user_avatar` varchar(255) NOT NULL DEFAULT 'default.png', `avatar_type` int(11) NOT NULL DEFAULT '0', `user_signature` varchar(255) NOT NULL,`about_user` varchar(255) NOT NULL, `location` varchar (2) NOT NULL DEFAULT '--', `gender` int(1) DEFAULT '0', `date_joined` int(11) NOT NULL,`user_birthday` date NOT NULL, `additional_permissions` varchar(255) NOT NULL DEFAULT '0',  `user_group` int(11) NOT NULL DEFAULT '1', `display_group` INT NOT NULL, `chosen_theme` int(11) NOT NULL DEFAULT '0', `set_timezone` varchar(255) NOT NULL DEFAULT 'US/Central', `user_disabled` int(11) NOT NULL DEFAULT '0', `is_banned` int(11) NOT NULL DEFAULT '0', `unban_time` int(11) NOT NULL, `ban_reason` varchar(255) NOT NULL DEFAULT 'None', `facebook_id` varchar(100) NOT NULL DEFAULT '0', PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;");
