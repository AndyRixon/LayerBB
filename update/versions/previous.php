...
$MYSQL->query("INSERT INTO `" . MYSQL_PREFIX . "usergroups` (`id`,`group_name`,`group_style`,`group_permissions`,`is_staff`) VALUES('0', 'Guest', '', '1', '0');");
$MYSQL->query("ALTER TABLE `" . MYSQL_PREFIX . "generic` ADD board_signature LONGTEXT NOT NULL;");
$MYSQL->query("ALTER TABLE `" . MYSQL_PREFIX . "generic` DROP `facebook_authenticate`, DROP `facebook_app_id`, DROP `facebook_app_secret`;");
